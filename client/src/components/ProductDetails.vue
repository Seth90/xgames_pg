<template>
    <div class="product">
        <div class="product-top">
            <div class="product-top">
                <div class="product-top-poster"><img :src="product.poster" :alt="product.title"></div>
        ...
        <div class="product-prices">
            {{ list }}
            <div class="product-price-item" v-for="price in list" :key="price.country">
